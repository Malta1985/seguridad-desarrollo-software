...
logger = logging.getLogger('servicio-multiplicacion')
trace.set_tracer_provider(TracerProvider(resource=Resource.create({'service.name': 'servicio-multiplicacion'})))
...
app = FastAPI(title='Servicio de multiplicacion (demo educativa)')
...
@app.get('/salud')
def salud() -> dict:
    return {'ok': True, 'servicio': 'servicio-multiplicacion'}
