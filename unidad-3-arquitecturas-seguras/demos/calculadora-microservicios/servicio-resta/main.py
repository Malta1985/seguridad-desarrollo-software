...
logger = logging.getLogger('servicio-resta')
trace.set_tracer_provider(TracerProvider(resource=Resource.create({'service.name': 'servicio-resta'})))
...
app = FastAPI(title='Servicio de resta (demo educativa)')
...
@app.get('/salud')
def salud() -> dict:
    return {'ok': True, 'servicio': 'servicio-resta'}
